...
public class SettingPanel extends JFrame {
    ...
    private void initComponents() {
        ...
        //======== panel6 ========
        {
            ...
            panel6.add(label11, "cell 0 2");
            panel6.add(maxThreads, "cell 1 2");

            //---- label12 ----
            label12.setText("TestNumber:");
            panel6.add(label12, "cell 2 2");
            panel6.add(testNumber, "cell 3 2");
            ...
            label21.setToolTipText("output path of parsed information.");
            panel6.add(label21, "cell 0 4");
            panel6.add(tmpOutput, "cell 1 4 2 1");
